...
strongswan & 5.5.0 & v1, v2 & \ac{WFP} & MOBIKE, eap-tls, eap-ttls, eap-tnc, 
...
Windows Agile VPN Client & foo & v1, v2 & Userspace & MOBIKE, IKEv1-Fragmentierung, ... & hat Probleme
beim Installieren der Routen für den ausgehandelten \ac{TS}, kein \ac{DPD}, keine 
\ac{MFA} möglich, nur schwacher \ac{DH} verfügbar, keine Installation von Routen 
für IPv6.\footcite{_windows7_2016} \\ \hline 

Shrewsoft Client & 2.2.2 & v1 & Userspace & \ac{NAT-T}, NAT keepalive, IKE-Fragmentierung,
RSA-Authentifizierung in allen Varianten, Main-Mode, Aggressive-Mode, Configuration-Mode, Quic-Mode,
...
NCP client & 10.10.03 r30578 & v1, v2& Userspace & & \\ \hline
bintec\footcite[][]{} & 3.10 &v1, v2 & Userspace & PSK-Authentifizierung, Authentifizierung 
