...
Der Zweck Reauthentifizierung einer IKE\_SA ist zu überprüfen, ob die Authentifizierungsinformation
...
Es existiert einerseits der KLIPS-Stack, der konform zu RFC 2367\footcite[][]{daniel_l._mcdonald_rfc_1998} ist
und auf Route based IPsec basiert. strongSwan unterstützt diesen Stack.

Des weiteren gibt es den XFRM-Stack, welcher auf Policy based IPsec basiert, jedoch mithilfe eines \ac{VTI}
auch für Route based IPsec genutzt werden kann. Auch dieser wird von strongSwan unterstützt.
