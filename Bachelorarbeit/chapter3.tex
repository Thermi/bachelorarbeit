...
Wenn das Array nicht mittels \texttt{WaitForSingleObject()} nach signalisierten Events
...
Die Implementierung von \ŧexttt{handle\_plain()} auf Windows unterstütz, wie die Implementierung
