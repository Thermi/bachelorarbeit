...
"charon.install_virtual_ip_on" von strongswan.conf, der während der Initialisierung
...
%TODO: Codebeispiele?
Nachgerüstet werden musste Code zum Beachten des "charon.install_virtual_ip_on" Parameters
...
\begin{lstlisting}[caption=Ergänzung zu private_kernel_iph_net_t]
/**
...
\begin{lstlisting}[caption=Code für add_ip]
...
\begin{lstlisting}[caption=Code für del_ip]
...
\begin{lstlisting}[caption=Ergänzung zu kernel_iph_net_create()]
*
 * Described in header.
 */
